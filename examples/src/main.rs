...
fn print_iteration_results(results: &BenchmarkResults, iteration: usize) {
    ...
    println!("Transactions per second: {:.2}", results.transactions_per_second);
...
pub fn print_benchmark_results(results: &BenchmarkResults) {
    ...
    println!("Average transactions per second: {:.2}", results.transactions_per_second);
    println!("Average operations per second: {:.2}", results.operations_per_second);
}
